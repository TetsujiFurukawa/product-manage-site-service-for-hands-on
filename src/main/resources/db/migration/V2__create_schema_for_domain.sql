...
create table SUB_MENU_MST (
  ...
  , SUB_MENU_ODER smallint not null
...
comment on column SUB_MENU_MST.SUB_MENU_ODER is 'サブメニュー並び順';
...
comment on column MENU_MST.MENU_ODER is 'メニュー並び順';
